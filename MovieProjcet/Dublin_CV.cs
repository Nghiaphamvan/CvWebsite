...
{
    public partial class Dublin_CV : Form
    {
        public Dublin_CV()
        {
            InitializeComponent();
        ...
        private void btn_Generate_Click(object sender, EventArgs e)
        {
            ...
            {
                Dublin_Employment newEmployment = new Dublin_Employment();
                ...
                foreach (string Descrip in DescriptionList)
                {
                    ...
                    {
                        newEmployment.lbl_Description.Height += 20;
                    }
                ...
                newEmployment.lbl_Description.Height = newEmployment.lbl_Description.Height + 10 * DescriptionList.Length;
            ...
            {
                Dublin_Education newEducation = new Dublin_Education();
                ...
                foreach (string Descrip in DescriptionList)
                {
                    ...
                    if (Descrip.Length > 80)
                    {
                        newEducation.lbl_Description.Height += 20;
                    }
                    else if (Descrip.Length > 40)
                    {
                ...
                newEducation.lbl_Description.Height = newEducation.lbl_Description.Height + 10 * DescriptionList.Length;
            ...
            foreach (Attr_Skill skill in Flpnl_Skill_Body.Controls)
            {
                Dublin_Skill newSkill = new Dublin_Skill();
